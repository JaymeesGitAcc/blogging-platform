...
import { Upload, Save, ImagePlus, Tag, X, Undo } from "lucide-react"
...
const PostForm = ({ post }: PostFormProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let response
      if (!post) response = await createPost(formData)
      else response = await updatePost(post._id, formData)
  ...
  const handleReset = () => {
    if (post) {
      ...
      setCoverImage(null)
      setImagePreview(post.coverImage?.url)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      {/* Main Content */}
      <div className="max-w-5xl mx-auto md:px-6 md:py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          {/* Main Form */}
          <div className="lg:col-span-2 space-y-6">
            {/* Title Section */}
            <Card className="mt-8 rounded-none md:rounded-xl md:mt-0">
              <CardHeader>
          ...
          <div className="space-y-6">
            ...
            {/* Tips Card */}
            <Card className="bg-gradient-to-br from-primary/5 to-purple-500/5 border-primary/20 rounded-none md:rounded-xl">
              <CardHeader>
            ...
            {/* Action Buttons */}
            <Card className="rounded-none md:rounded-xl my-4">
